...
const Biconomy: React.FC<Props> = (
    ...
    return (
        <>
            {
                !biconomyWallet && !loading && <Button onClick={login}>Login with Biconomy</Button>
            }
            {
                loading && <Button disabled>Loading Biconomy account...</Button>
            }
            {
                !!walletAddress && (
                    <Button onClick={logout}>Logout from Biconomy</Button>
                )
            }
        </>
    )
